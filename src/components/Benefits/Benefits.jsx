                ...
                <g id="headphones 1">
                  <g id="Group">
                    <g id="Group_2">
                      <path
                        id="Vector"
                        d="M24 0C12.3689 0 2.90625 9.46266 2.90625 21.0938C2.90625 22.3827 2.90625 32.3539 2.90625 32.5312C2.90625 34.8575 4.79878 36.75 7.125 36.75H8.77313C9.35363 38.3867 10.9167 39.5625 12.75 39.5625C15.0762 39.5625 16.9688 37.67 16.9688 35.3438V23.9062C16.9688 21.58 15.0762 19.6875 12.75 19.6875C10.9167 19.6875 9.35363 20.8633 8.77313 22.5H7.125C6.63197 22.5 6.15891 22.5858 5.71875 22.7419V21.0938C5.71875 11.0135 13.9197 2.8125 24 2.8125C34.0803 2.8125 42.2812 11.0135 42.2812 21.0938V22.7419C41.8411 22.5858 41.368 22.5 40.875 22.5H39.2269C38.6464 20.8633 37.0833 19.6875 35.25 19.6875C32.9238 19.6875 31.0312 21.58 31.0312 23.9062V35.3438C31.0312 37.67 32.9238 39.5625 35.25 39.5625C35.6757 39.5625 36.0867 39.4986 36.4745 39.3807C35.9484 41.1115 34.338 42.375 32.4375 42.375H27.9769C27.3964 40.7383 25.8333 39.5625 24 39.5625C21.6738 39.5625 19.7812 41.455 19.7812 43.7812C19.7812 46.1075 21.6738 48 24 48C25.8333 48 27.3964 46.8242 27.9769 45.1875H32.4375C36.3145 45.1875 39.4688 42.0333 39.4688 38.1562V36.75H40.875C43.2012 36.75 45.0938 34.8575 45.0938 32.5312C45.0938 32.3565 45.0938 22.3817 45.0938 21.0938C45.0938 9.46266 35.6311 0 24 0ZM11.3438 23.9062C11.3438 23.1308 11.9746 22.5 12.75 22.5C13.5254 22.5 14.1562 23.1308 14.1562 23.9062V35.3438C14.1562 36.1192 13.5254 36.75 12.75 36.75C11.9746 36.75 11.3438 36.1192 11.3438 35.3438V23.9062ZM7.125 25.3125H8.53125V33.9375H7.125C6.34959 33.9375 5.71875 33.3067 5.71875 32.5312V26.7188C5.71875 25.9433 6.34959 25.3125 7.125 25.3125ZM24 45.1875C23.2246 45.1875 22.5938 44.5567 22.5938 43.7812C22.5938 43.0058 23.2246 42.375 24 42.375C24.7754 42.375 25.4062 43.0058 25.4062 43.7812C25.4062 44.5567 24.7754 45.1875 24 45.1875ZM36.6562 35.3438C36.6562 36.1192 36.0254 36.75 35.25 36.75C34.4746 36.75 33.8438 36.1192 33.8438 35.3438V23.9062C33.8438 23.1308 34.4746 22.5 35.25 22.5C36.0254 22.5 36.6562 23.1308 36.6562 23.9062V35.3438ZM42.2812 32.5312C42.2812 33.3067 41.6504 33.9375 40.875 33.9375H39.4688V25.3125H40.875C41.6504 25.3125 42.2812 25.9433 42.2812 26.7188V32.5312Z"
                        fill="#156963"
                      />
                    </g>
                  </g>
          ...
          <div className="benefits-card">
            <div className="ttl">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g id="plant 1" clip-path="url(#clip0_0_45)">
                  <g id="Group">
                    <g id="Group_2">
                      <path
                        id="Vector"
          ...
          <div className="benefits-card">
            <div className="ttl">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g id="dollar-symbol 1" clip-path="url(#clip0_0_61)">
                  <path
                    id="Vector"
